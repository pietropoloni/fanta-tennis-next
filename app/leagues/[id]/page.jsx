...
export default function LeagueDetailPage() {
  ...
  const [sortBy, setSortBy] = useState("spentDesc"); // spentDesc | picksDesc | nameAsc
  ...
  async function loadAll() {
    ...
    const { data: picks, error: pErr } = await supabase
      ...
      .in("team_id", teamIds.length ? teamIds : ["00000000-0000-0000-0000-000000000000"]); // safe when empty
    if (pErr) throw pErr;
